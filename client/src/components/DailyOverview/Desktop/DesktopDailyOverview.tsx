					...
					<Grid item container className={classes.rightContainer}>
						...
						<Grid item container className={classes.cardContainer}>
							<DataCard
								...
								windDirection={
									userLog.windDirection !== ''
										? userLog.windDirection
										: 'noWind'
								}
								bottomInfo={
									GetBottomInfo(
										dataEnum.WIND_DIRECTION,
										userLog.windDirection !== '' ? userLog.windDirection : ''
									)!
								}
							/>
							<DataCard
								...
								unit="m/s"
								bottomInfo={
									GetBottomInfo(dataEnum.WIND_SPEED, userLog?.windSpeed)!
								}
							/>
							<DataCard
							...
							<DataCard
								...
								unit="mm"
								bottomInfo={
									GetBottomInfo(dataEnum.PRECIPITATION, userLog?.precipitation)!
								}
							/>
							<DataCard
								...
								bottomInfo={
									GetBottomInfo(
										dataEnum.AIR_PRESSURE,
										userLog.airpressure !== '' ? userLog.airpressure : '0'
									)!
								}
							/>
							<DataCard
								...
								bottomInfo={
									GetBottomInfo(
										dataEnum.HUMIDITY,
										userLog.humidity !== '' ? userLog.humidity : 0
									)!
								}
							/>
						</Grid>
